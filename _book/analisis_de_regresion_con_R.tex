...
pero también se puede escribir como en latex con \textbackslash{}begin
equation y \textbackslash{}end equation así:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{n=}\DecValTok{100}\NormalTok{)}
