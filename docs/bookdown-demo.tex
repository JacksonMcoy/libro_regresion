...
\includegraphics[width=0.33\linewidth]{images/cover}
...
por medio de lenguage de programación R.
...
presentados. Los códigos se destacan en una caja de color similar a la
...
\section{Regresión lineal simple}\label{rls}
...
\section{Regresión lineal múltiple}\label{rlm}
